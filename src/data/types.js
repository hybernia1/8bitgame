 ...
 * @property {{ sources?: Array<{ tx: number, ty: number }>, switches?: Array<{ id: string, name: string, tx: number, ty: number, timerSeconds?: number, lights?: Array<{ x: number, y: number, w: number, h: number }> }> }} [lighting]
