export const messages = {
  ...
  'prompt.switchOn': 'Stiskni E pro zapnutí vypínače',
  'prompt.switchOff': 'Stiskni E pro vypnutí vypínače',
  ...
  'prompt.safeLocked': 'Stiskni E pro zadání kódu sejfu.',
  'prompt.safeOpened': 'Sejf je otevřený.',
  ...
  'note.switch.activatedTimed': 'Vypínač {name} rozsvítil další část místnosti na {seconds} s.',
  'note.switch.deactivated': 'Vypínač {name} zhasnul.',
  ...
  'note.safe.enterCode': 'Zadej {digits}-místnou kombinaci.',
  'note.safe.wrongCode': 'Kombinace nesedí. Zkus to znovu.',
  'note.safe.unlocked': 'Mechanismus cvakl a sejf povolil.',
  'note.safe.empty': 'Sejf je prázdný.',
  'note.safe.itemReceived': 'Ze sejfu získáváš: {item}.',
  'note.safe.inventoryFull': 'Batoh je plný, nejprve uvolni místo pro {item}.',
  'note.quiz.correct': 'Správně! Pokračuj dál.',
  'note.quiz.wrong': 'To není správně. Zkus to znovu.',
  'note.quiz.reward': 'Správně! Dostáváš jablko.',
  'note.quiz.inventoryFull': 'Batoh je plný, nejprve uvolni místo pro odměnu.',
